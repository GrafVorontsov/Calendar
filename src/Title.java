public class Title {
    //название уроков
    public String getUkrmova() { return "Українська мова"; }

    public String getUkrLit() { return "Українська література"; }
    ...
    public String getFizra() { return "Фiз-ра"; }

    public String getTechnology() { return "Технології"; }

    public String getMystectvo() { return "Образотворче мистецтво"; }

    public String getHistory() { return "Історія"; }
